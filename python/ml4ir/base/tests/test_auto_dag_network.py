...
class TestGetLayerSubclasses(unittest.TestCase):
    ...
    def test_keras_native_subclass(self):
        """Test that all globally defined classes are accessible"""
        self.assertIn("tf_keras.src.layers.core.dense.Dense", self.layer_subclasses)
            ...
            layers:
              ...
              - type: ml4ir.base.tests.test_auto_dag_network.UserDefinedTestLayerGlobal
                ...
                inputs:
                  ...
                  - page_views_score
                aslist: true
              - type: tf_keras.src.layers.merging.concatenate.Concatenate
                ...
                args:
                  axis: -1
              - type: tf_keras.src.layers.core.dense.Dense
                name: first_dense
                inputs:
                  - features_concat
                args:

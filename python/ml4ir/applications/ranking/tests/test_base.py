...
class RankingTestBase(RelevanceTestBase):
    ...
    def get_ranking_model_dual_objective(
            self,
            loss_key='',
            metrics_keys=[],
            feature_config=None,
            ...
            freeze_layers_list=[],
            output_name=None,
            aux_output_name=None,
            primary_loss_weight=0,
            aux_loss_weight=0,
        ...
        losses = {output_name: loss, aux_output_name: aux_loss}
        ...
        aux_metrics: List[Union[Type[Metric], str]] = [
            metric_factory.get_metric(metric_key=metric_key) for metric_key in metrics_keys
        ]
